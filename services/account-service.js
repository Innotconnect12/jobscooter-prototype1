...
class AccountService {
    ...
    async sendWelcomeEmail({ email, first_name, username, password, verificationToken, profileSlug }) {
        try {
            const verificationLink = `${process.env.BASE_URL || 'http://localhost:3001'}/verify-email?token=${verificationToken}`;
            const loginLink = `${process.env.BASE_URL || 'http://localhost:3001'}/login`;
            const profileLink = `${process.env.BASE_URL || 'http://localhost:3001'}/profile/${profileSlug}`;
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <hr>
                                <p><strong>Need Help?</strong> Reply to this email or visit our <a href="${process.env.BASE_URL || 'http://localhost:3001'}/help">Help Center</a></p>
